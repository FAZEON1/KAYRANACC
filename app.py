...
def giris_ekrani():
    # Login sayfası özel CSS — ana CSS'in renk override'larını agresif şekilde ezer
    st.markdown("""
    <style>
        /* Sidebar gizle */
        ...
        .stApp {
            background: linear-gradient(135deg, #0B1225 0%, #1E2A4A 50%, #0B1225 100%) !important;
        }

        /* ── LOGIN SAYFASI YAZI RENKLERİ — AGRESİF OVERRIDE ── */
        /* Ana CSS'teki .stMarkdown, p, span, div { color: #0F172A } kuralını ez */
        .login-page-content,
        .login-page-content *,
        ...
        /* Login form kartı içindeki yazılar her zaman koyu */
        .login-card,
        .login-card *,
        .login-card p,
        .login-card span,
        ...
        /* Form alanları */
        .login-card-form [data-testid="stForm"] {
            background: transparent !important;
            border: none !important;
            box-shadow: none !important;
            padding: 0 !important;
        ...
        .login-card-form button[kind="primary"] {
        ...
        .login-card-form button[kind="primary"] *,
        .login-card-form button[kind="primary"] p {
            color: #FFFFFF !important;
        }
        .login-card-form button[kind="primary"]:hover {
            transform: translateY(-2px) !important;
    ...
    col_sol, col_sag = st.columns([1.05, 1], gap="large")
    ...
    with col_sol:
        st.markdown("""
<div class="login-page-content" style="min-height:90vh;display:flex;flex-direction:column;justify-content:center;padding:60px 0;">

  <!-- Logo ve Marka -->
  <div style="display:inline-flex;align-items:center;gap:14px;margin-bottom:48px;">
    <div style="
    ...
    ">💳</div>
    <div>
      <div style="font-size:24px;font-weight:800;color:#FFFFFF !important;letter-spacing:-.5px;line-height:1;">KAYRANACC</div>
      <div style="font-size:11px;color:#A5B4FC !important;font-weight:700;letter-spacing:2px;text-transform:uppercase;margin-top:4px;">Finance Suite</div>
    </div>
  </div>
  ...
  ">
    Ödemelerinizi<br>
    <span style="
        background:linear-gradient(135deg,#60A5FA,#A5B4FC,#C4B5FD);
        -webkit-background-clip:text;
        -webkit-text-fill-color:transparent;
        background-clip:text;
        display:inline-block;
    ">profesyonelce</span> yönetin
  </h1>
  ...
  <div style="display:flex;flex-direction:column;gap:18px;max-width:460px;">
    ...
    <div style="display:flex;align-items:center;gap:14px;">
      ...
      ">📊</div>
      <div>
        <div style="color:#FFFFFF !important;font-size:14px;font-weight:700;line-height:1.3;">Anlık Dashboard</div>
        <div style="color:#CBD5E1 !important;font-size:12px;margin-top:3px;font-weight:400;line-height:1.4;">Haftalık özet, alarmlar ve ilerleme takibi</div>
      </div>
    </div>
    ...
    <div style="display:flex;align-items:center;gap:14px;">
      ...
      ">💸</div>
      <div>
        <div style="color:#FFFFFF !important;font-size:14px;font-weight:700;line-height:1.3;">Nakit Akış Analizi</div>
        <div style="color:#CBD5E1 !important;font-size:12px;margin-top:3px;font-weight:400;line-height:1.4;">Günlük kümülatif projeksiyon ve grafikler</div>
      </div>
    </div>
    ...
    <div style="display:flex;align-items:center;gap:14px;">
      ...
      ">🔒</div>
      <div>
        <div style="color:#FFFFFF !important;font-size:14px;font-weight:700;line-height:1.3;">Güvenli Erişim</div>
        <div style="color:#CBD5E1 !important;font-size:12px;margin-top:3px;font-weight:400;line-height:1.4;">Bulut senkronizasyonlu, şifre korumalı</div>
      </div>
    </div>
    ...
    # ═══════════════════════════════════════════════
    # SAĞ PANEL — Login Formu (Tek Kart)
    # ═══════════════════════════════════════════════
    with col_sag:
        # Üst boşluk (dikey ortalama için)
        st.markdown("<div style='height:80px;'></div>", unsafe_allow_html=True)

        # ── Tek bütünleşik beyaz kart başlangıcı ──
        st.markdown("""
<div style="display:flex;justify-content:center;padding:0 10px;">
  ...
  ">
    ...
    ">
      ...
      "></span>
      <span style="font-size:11px;font-weight:800;color:#047857 !important;letter-spacing:.5px;">SİSTEM HAZIR</span>
    </div>
    ...
    <p style="
        ...
        margin:0 0 28px 0;
        line-height:1.5;
    ">Devam etmek için kullanıcı adı ve şifrenizi girin.</p>

  </div>
</div>
        """, unsafe_allow_html=True)

        # ── Form, kartın bir devamı gibi negative margin ile yukarı çekilir ──
        st.markdown("""
<style>
  .login-card-form {
    max-width: 440px;
...
<!-- Footer -->
<div style="max-width:440px;margin:24px auto 0 auto;padding:0 20px;text-align:center;">
  <div style="
      font-size:11px;
      color:#94A3B8 !important;
      letter-spacing:.5px;
      font-weight:500;
  ">© 2026 KAYRANACC · Finance Management System</div>
</div>
        """, unsafe_allow_html=True)
...
if sayfa == "📊 Dashboard":
    ...
    varlik_html = (
        ...
        f'<div style="font-size:22px;font-weight:700;color:#075985;font-family:monospace">₺{fmt(banka_tl)}</div>'
        ...
        f'<div style="font-size:22px;font-weight:700;color:#15803D;font-family:monospace">${fmt(banka_usd)}</div>'
        ...
        f'<div style="font-size:22px;font-weight:700;color:#6B21A8;font-family:monospace">₺{fmt(toplam_varlik_tl)}</div>'
        f'<div style="font-size:11px;margin-top:6px;color:#9333EA">TL + USD x {kur}</div>'
        '</div>'
        '</div>'
    )

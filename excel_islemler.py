...
def excel_yukle_odeme_listesi(file_bytes):
    ...
    Sütun sırası: A=HAFTA, B=FİRMA, C=AÇIKLAMA, D=(boş), E=VADE, F=TUTAR TL, G=TUTAR USD, H=KATEGORİ
    """
    try:
...
def create_sample_excel():
    ...
    ws.append([])
    ws.append(["HAFTA", "FİRMA", "AÇIKLAMA", "", "VADE", "TUTAR TL", "TUTAR USD", "KATEGORİ"])
    ornekler = [
        ["", "ABC Lojistik", "Nakliye faturası", "", "2026-04-18", 45000, "", "cek"],
        ["", "XYZ Tedarik", "Ham madde", "", "2026-04-19", 120000, "", "cari"],
        ["", "Global Import", "USD ödeme", "", "2026-04-21", "", 5000, "kredi"],
        ["", "Ofis Giderleri", "Kira Nisan", "", "2026-04-22", 28000, "", "kira"],
    ]
    for o in ornekler:
        ws.append(o)
